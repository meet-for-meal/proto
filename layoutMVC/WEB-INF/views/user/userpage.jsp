...
<section id="container">
    ...
    <div class="wrapper userpage">
        ...
        <div class="col-2">
            ...
            <img src="/layoutMVC/res/styles/default/img/users/romain.jpg" width="64" height="64" class="avatar" alt="">
            <p>
                <i class="icon-user"></i><strong>Romain Deligny</strong>
            </p>
            <p>
            ...
            <p>
                Goûts culinaires : <a href="#">#francais</a> <a href="#">#indien</a>
            </p>
            <p>
                Centres d'intérêts : <a href="#">#football</a> <a href="#">#chien</a> <a href="#">#chat</a>
            </p>
            <p>
            ...
            <p>
                <i class="icon-eye-open"></i>Profil complété à <strong>50%</strong>
            </p>
            <p>
        ...
        <div class="col-1">
            ...
            <a href="userpage" title="Alexandra"><img src="/layoutMVC/res/styles/default/img/users/alexandra.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="userpage" title="Herve"><img src="/layoutMVC/res/styles/default/img/users/herve.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="userpage" title="Pierre"><img src="/layoutMVC/res/styles/default/img/users/pierre.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="userpage" title="Romain"><img src="/layoutMVC/res/styles/default/img/users/romain.jpg" width="64" height="64" class="avatar" alt=""></a>
        </div>
