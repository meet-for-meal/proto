...
<header>
    ...
    <div class="wrapper">
        ...
        <a href="index.html" id="logo"><img src="/layoutMVC/res/styles/default/img/logo-mini.png" alt=""></a>
        ...
        <nav>
            <ul>
                ...
                <li class="current"><a href="userpage.html"><i class="icon-user"></i>Mon profil</a></li>
...
<section id="container">
    ...
    <div class="wrapper userpage">
        ...
        <div class="col-2">
            ...
            <img src="/layoutMVC/res/styles/default/img/users/herve.jpg" width="64" height="64" class="avatar" alt="">
            <p>
            ...
            <p>
                Centres d'intérêts : <a href="#">#guitare</a> <a href="#">#blues</a> <a href="#">#poker</a>
            </p>
            <p>
            ...
            <p>
                <a href="#" class="btn"><i class="icon-envelope icon-plus"></i>Ajouter en ami</a> <a href="#" class="btn"><i class="icon-envelope icon-red"></i>Contacter cet utilisateur</a>
            </p>
        </div>
        ...
        <div class="col-1">
            ...
            <a href="display" title="Alexandra"><img src="/layoutMVC/res/styles/default/img/users/alexandra.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="display" title="Herve"><img src="/layoutMVC/res/styles/default/img/users/herve.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="display" title="Pierre"><img src="/layoutMVC/res/styles/default/img/users/pierre.jpg" width="64" height="64" class="avatar" alt=""></a>
            <a href="display" title="Romain"><img src="/layoutMVC/res/styles/default/img/users/romain.jpg" width="64" height="64" class="avatar" alt=""></a>
        </div>
