<link href="<%= request.getContextPath() %>/res/styles/default/homepage.css" rel="stylesheet">
...
<section id="container">
    ...
    <div class="wrapper">
        ...
        <div id="intro">
            ...
            <a href="index"><img src="/layoutMVC/res/styles/default/img/logo.png" id="logo" alt="" /></a>
