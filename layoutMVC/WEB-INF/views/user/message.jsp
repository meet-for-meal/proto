    ...
    <div class="wrapper">
        ...
        <nav>
            <ul>
                ...
                <li class="current"><a href="message.html" class="no-text"><i class="icon-envelope"></i></a></li>
        ...
        <div id="conversations" class="col-1">
            ...
            <ul>
                <li class="conversation current">
                    <img src="/layoutMVC/res/styles/default/img/users/pierre.jpg" width="64" height="64" class="avatar" alt="">
