...
<section id="container">
    ...
    <div class="wrapper">
        ...
        <div class="col-2">
            <h2>Tous les résultats pour "Bastian PEGHAIRE"</h2>
            <ul>
                <li class="result-search">
                    <div class="user-interact">
                        <a href="#" title="" class="btn see-profile"><i class="icon-eye-open"></i>Voir le profil</a>
                        <a href="#" title="" class="btn add-friend"><i class="icon-plus"></i>Ajouter comme ami</a>
                    ...
                    <div class="user-content">
                        <p>
                            ...
                            <i class="icon-glass"></i>Préférences culinaires : <a href="#">#chinois</a> <a href="#">#grec</a> <a href="#">#pizzeria</a> <a href="#">#japonais</a>
                        </p>
                    </div>
                </li>
                ...
                <li class="result-search">
                    ...
                    <img src="/meetformeal/res/styles/default/img/users/romain.jpg" width="40" height="40" class="avatar" alt="">
                    <a href="userpage.html">
                        <span class="user-title">Bastien PENNE GUERRE</span>
                    </a>
                    <div class="user-content">
                        <p>
                            <i class="icon-heart"></i>Centres d'intérêts : <a href="#">#jeuxvideos</a> <a href>#femmes</a><br>
                            <i class="icon-glass"></i>Préférences culinaires : <a href="#">#francais</a> <a href="#">#italien</a>
                        </p>
                    </div>
                </li>
